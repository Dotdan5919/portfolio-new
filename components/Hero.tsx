...
export function SpotlightPreview() {
  return (
    <div className="relative flex h-[60rem] max-h-dvh pt-64 pb-9 w-full overflow-hidden  bg-black/[0.96] antialiased md:items-center md:justify-center">
      <div
        className={cn(
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl p-4 pt-20 md:pt-0">
       ...
       Ighodaro osakpolo <br/> Daniel
        ...
        <p className="mx-auto mb-10 mt-4 max-w-lg text-center text-base font-normal text-neutral-300">
